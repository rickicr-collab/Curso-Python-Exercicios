...
print('O valor {} será em centrimentros:{}cm'.format(medida, cm))#print da função com valor em centrimentos 
print('O valor {} será em milimetros:{}mm'.format(medida,mm))#print da função com valor em milimetros
print('O valor {} em decimetros:{}dm'.format(medida,dm))#print da função com valor em decimetros 
print('O valor {} em decametro:{}dam'.format(medida,dam))#print da função com valor em decametros
print('O valor {} em hectometro:{}hm'.format(medida,hm))#print da função com valor em hectometro
print('O valor {} em kilometro:{}km'.format(medida,km))#print da função com valor em kilometros 
#------------------------------------------------------------------------------------------------------------